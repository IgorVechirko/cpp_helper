...
namespace ValotileRegisterKeyWords
{
	...
	{
		register char registerVariable = 3;//hit for compiler that variable using very ofter an can be placed in to register or can be granted with higher priority
